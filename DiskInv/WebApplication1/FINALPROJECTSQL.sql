...
Removed Inventory table 12/2
Added CDstatus attribute to CD table 12/2
Removed references to Inventory ID and replaced them with CD_ID 12/2
Rearranged Table assembly to fit new database structure 12/2
Modified Artist Stored procedures
*/
...
INSERT INTO CD( CD_Name, Genre, Release_Date, CDstatus)
VALUES ('20 Jazz Funk Greats', 'Experimental', '12/01/1979', 'not available'),
		('The Worst Of Monte Cazazza', 'Noise', '01/01/1992', 'not available'),
		('Birthdeath Experience', 'Noise', '09/01/1980', 'available'),
		('The Velvet Underground With Nico', 'Avant-Pop', '03/12/1967', 'available'),
		('Pop', 'Ambient', '03/28/2000', 'available'),
		('Blue Limbo', 'Electro-Pop', '02/13/2003', 'available'),
		('A Simple Mark', 'Noise', '01/01/1998', 'available'),
		('My So-Called Life', 'IDM DNB', '08/24/2010', 'available'),
		('Richard D. James Album', 'IDM', '11/04/1996', 'available'),
		('Discovery', 'House', '02/26/2001', 'available'),
		('Soisong', 'Experimental', '01/01/2007', 'available'),
		('Fire Of The Mind // The Ape Of Naples', 'Avant Pop', '12/02/2005', 'available'),
		('Scatology', 'Industrial', '01/01/1984', 'available'),
		('Heathen Earth', 'Industrial', '06/01/1980', 'available'),
		('The Second Annual Report', 'Industrial', '11/01/1977', 'available'),
		('The Third Annual Report of Throbbing Gristle', 'Industrial', '12/04/1978', 'available'),
		('Live at the Highbury Roundhouse', 'Industrial', '01/01/1977', 'available'),
		('Live at the Death Factory', 'Industrial', '05/01/1979', 'available'),
		('TG NOW', 'Post-Industrial', '05/16/2004', 'available'),
		('Ambient 1: Music For Airports', 'Ambient', '03/01/1978', 'available');
...
INSERT INTO Borrow_details(Borrower_ID, CD_ID, Borrowed_Date, Returned_Date)
...
INSERT INTO Disk_Has_Artist (CD_ID, Artist_ID)
VALUES(1, 2),
		(1, 3),
		(1, 4),
		(1, 5),
...
FROM CD 
JOIN Disk_Has_Artist ON CD.CD_ID = Disk_Has_Artist.CD_ID
...
EXEC sp_InsArtist 'Cher',null , 'Individual'
GO
...
GO
--stored procedure execution
EXEC sp_UpdArtist 21, 'Bruno','Mars', 'Individual'
GO
...
BEGIN TRY
	...
	DELETE FROM [dbo].[Disk_Has_Artist]
	WHERE Artist_ID = @Artist_ID
...
GO
--stored procedure execution
EXEC sp_InsCD 'The Kick Inside', '02/17/1978', 'Pop', 'available'
GO
...
GO
--stored procedure execution
EXEC sp_UpdCD 21, 'Filth', '01/01/1983', 'Experimental Rock', 'available'
GO
...
--error handling
BEGIN TRY
	DELETE FROM [dbo].[Borrow_details]
	WHERE CD_ID =@CD_ID
